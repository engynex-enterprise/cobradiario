...
const styles = StyleSheet.create({
  ...
  tab: { paddingVertical: 9, paddingHorizontal: 18, borderRadius: 999, borderWidth: 2, borderColor: colors.border, backgroundColor: colors.card },
  tabActive: { backgroundColor: colors.primary, borderColor: colors.primaryDark, borderBottomWidth: 3 },
